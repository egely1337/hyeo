...
bc:
	...
	${CC} -ffreestanding -m32 -g -c ./kernel/kmain.cpp -o objects/kernel.o
	${CC} -ffreestanding -m32 -g -c ./kernel/syscall/syscall.cpp -o objects/syscall.o
	${CC} -ffreestanding -m32 -g -c ./kernel/keyboard/keyboard.cpp -o objects/keyboard.o
	${CC} -ffreestanding -m32 -g -c ./kernel/timer/timer.cpp -o objects/timer.o
	${CC} -ffreestanding -m32 -g -c ./kernel/mem/memory.cpp -o objects/mem.o
	${CC} -ffreestanding -m32 -g -c ./kernel/inc/io.cpp -o objects/io.o
	...
	i386-elf-ld --oformat binary -Ttext 0x8000  objects/init.o objects/syscall.o objects/runtime.o objects/mem.o objects/idtc.o objects/isr.o objects/keyboard.o objects/timer.o objects/io.o objects/tty.o  objects/isrc.o objects/kernel.o objects/vs.o  -o kernel.bin
