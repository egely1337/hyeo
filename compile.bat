...
wsl /home/hyper/i386-elf/i386-elf-7.5.0-Linux-x86_64/bin/i386-elf-ld --oformat binary -Ttext 0x8000 "init.o" "mem.o" "idtc.o" "isr.o" "timer.o" "io.o" "tty.o"  "isrc.o" "kernel.o"  -o "kernel.bin"
